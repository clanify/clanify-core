...
<div class="container">
    ...
    <div class="row content">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="col-md-4 col-sm-12 animated fadeInDown">
                <a class="btn btn-success btn-lg center-block" href="<?= URL ?>register">Sign Up</a>
            </div>
            <div class="col-md-4 col-sm-12 animated fadeInDown">
                <a class="btn btn-success btn-lg center-block" href="<?= URL ?>login">Login</a>
            </div>
            <div class="col-md-4 col-sm-12 animated fadeInDown">
                <a class="btn btn-info btn-lg center-block" href="<?= URL ?>info">Info</a>
            </div>
        </div>
    </div>
</div>
