            ...
            <div class="col-sm-5">
                <form class="ajax" method="post" data-action="<?= URL ?>login/login">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="login_username" placeholder="Username" class="form-control" id="username">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="password">Password</label>
                        <input type="password" name="login_password" placeholder="Password" class="form-control" id="password">
                    </div>
